...
public final class PayParams {
	 ...
	 * 编码类型
	 */
	public final static String	YEEPAY_CHARSET	= Params.getString("pay.yeepay.charset", "GBK");
	 ...
	 * 编码类型
	 */
	public final static String	CARD_CHARSET	= Params.getString("pay.card.charset", "GBK");
