...
// TODO(kevinb): provide replacement
   ...
   *     ordering.
   */
  public <E extends T> E min(@Nullable E a, @Nullable E b, @Nullable E c, @SuppressWarnings("unchecked") E... rest) {
   ...
   *     ordering.
   */
  public <E extends T> E max(@Nullable E a, @Nullable E b, @Nullable E c, @SuppressWarnings("unchecked") E... rest) {
