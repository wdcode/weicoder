...
public abstract class Email
{
    ...
    public Session getMailSession()
    {
        if (this.session == null)
        {
            ...
            if (EmailUtils.isEmpty(this.hostName))
            {
                throw new RuntimeException("Cannot find valid hostname for mail session");
            }
     ...
     * @return An Email.
     * @ Indicates an invalid email address or charset.
     * @since 1.1
     */
        ...
        
    {
        ...
        {
            throw new RuntimeException("Address List provided was invalid");
        }
    ...
    public Email setBounceAddress(final String email)
    {
        ...
        if (email != null && !email.isEmpty())
        {
            ...
            {
                // Can't throw 'RuntimeException' to keep backward-compatibility
    ...
    public void buildMimeMessage() 
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    throw new RuntimeException("From address required");
                }
            }

            if (this.toList.size() + this.ccList.size() + this.bccList.size() == 0)
            {
                throw new RuntimeException("At least one receiver address required");
            }
    ...
    */
     ...
     * @ Thrown when the supplied address, name or charset were invalid.
     */
