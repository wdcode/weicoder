...
public class MultiPartEmail extends Email
{
     ...
     *  @since 1.0
     */
    public Email addPart(final MimeMultipart multipart) 
    {
        try
        {
     ...
     * @return The email.
     * @ An error occurred while adding the part.
     * @since 1.0
     */
    public Email addPart(final MimeMultipart multipart, final int index) 
    {
        final BodyPart bodyPart = createBodyPart();
        try
        {
        ...
        
    {
        ...
        {
            throw new RuntimeException("Cannot attach file \"" + fileName + "\"", e);
        }
    }
        ...
        
    {
        ...
        if (attachment == null)
        {
            throw new RuntimeException("Invalid attachment supplied");
        }
        ...
        
    {
       ...
       {
           throw new RuntimeException("Invalid URL set:" + url, e);
       }
        ...
        
    {
        ...
        {
            throw new RuntimeException("Invalid Datasource", e);
        }
