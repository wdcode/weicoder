...
public class HtmlEmail extends MultiPartEmail
{
     ...
     * @since 1.0
     */
    public HtmlEmail setTextMsg(final String aText) 
    {
        if (EmailUtils.isEmpty(aText))
        {
            throw new RuntimeException("Invalid message supplied");
        }
     ...
     * @since 1.0
     */
    public HtmlEmail setHtmlMsg(final String aHtml) 
    {
     ...
     * @ when URL supplied is invalid or if {@code name} is null
     * or empty; also see {@link javax.mail.internet.MimeBodyPart} for definitions
     *
     * @see #embed(URL, String)
     * @since 1.1
     */
    public String embed(final String urlString, final String name) 
    {
        try
        {
     ...
     * <code>RuntimeException</code> if the validation fails. In this case, the
     ...
     * <code>RuntimeException</code>. However, it is not guaranteed to catch
     ...
     * @since 1.0
     */
    public String embed(final URL url, final String name) 
    {
        ...
        if (inlineEmbeds.containsKey(name))
        {
            ...
            throw new RuntimeException("embedded name '" + name
    ...
    public String embed(final File file, final String cid) 
    {
        ...
        if (inlineEmbeds.containsKey(file.getName()))
        {
            ...
            {
                throw new RuntimeException("couldn't get canonical path for file "
            ...
            throw new RuntimeException("embedded name '" + file.getName()
        ...
        if (!file.isFile())
        {
            throw new RuntimeException("file " + filePath + " isn't a normal file");
        }
        if (!file.canRead())
        {
            throw new RuntimeException("file " + filePath + " isn't readable");
        }
     ...
     * @ if the embedding fails or if <code>name</code> is
     * null or empty
     * @see #embed(DataSource, String, String)
     * @since 1.1
     */
    public String embed(final DataSource dataSource, final String name) 
    {
        ...
        if (inlineEmbeds.containsKey(name))
        {
            ...
            throw new RuntimeException("embedded DataSource '" + name
     ...
     */
    private void build() throws MessagingException, RuntimeException
    {
