...
public class MessagingException extends Exception {
	...
	/**
	 * Overrides the <code>getCause</code> method of <code>Throwable</code> to return the next exception in the chain of nested exceptions.
	 *
	 * @return next Exception, null if none.
	 */
	@Override
	...
	/**
	 * Add an exception to the end of the chain. If the end is <strong>not</strong> a MessagingException, this exception cannot be added to the end.
	 *
	 * @param  ex the new end of the Exception chain
	 * @return    <code>true</code> if this Exception was added, <code>false</code> otherwise.
	 */
