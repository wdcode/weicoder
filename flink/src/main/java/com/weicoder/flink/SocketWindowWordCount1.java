...
public class SocketWindowWordCount1 {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * final int port; try { final ParameterTool params = ParameterTool.fromArgs(args); port =
		 * params.getInt("port"); } catch (Exception e) {
		...
		DataStream<String> text = env.socketTextStream("192.168.52.130", 9999, "\n");
