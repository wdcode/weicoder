...
public abstract class AbstractCollectionConverter implements Converter {
	...
	/**
	 * @deprecated As of 1.4.11 use {@link #writeCompleteItem(Object, MarshallingContext, HierarchicalStreamWriter)} instead.
	 */
	...
	/**
	 * @deprecated As of 1.4.11 use {@link #readBareItem(HierarchicalStreamReader, UnmarshallingContext, Object)} or {@link #readCompleteItem(HierarchicalStreamReader, UnmarshallingContext, Object)}
	 *             instead.
	 */
	...
	protected Object createCollection(Class type) {
		...
		try {
			...
			throw new RuntimeException("Cannot instantiate default collection", e);
		} catch (IllegalAccessException e) {
			throw new RuntimeException("Cannot instantiate default collection", e);
		}
//		throw new RuntimeException("collection-type" + type.getName() + "default-type" + defaultType.getName()); 
	}
}
