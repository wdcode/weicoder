...
public class PureJavaReflectionProvider implements ReflectionProvider {
    ...
    public Object newInstance(Class type) { 
        try {
            ...
            if (Serializable.class.isAssignableFrom(type)) {
            	...
            	throw new RuntimeException("Cannot construct type as it does not have a no-args constructor");
            }
        } catch (InstantiationException e) {
        	throw new RuntimeException("Cannot construct type", e);
            ...
            if (e.getTargetException() instanceof RuntimeException) {
                ...
                throw new RuntimeException("Constructor for type threw an exception", e.getTargetException());
            }
        } 
    }
    ...
    private Object instantiateUsingSerialization(final Class type) { 
        try {
        	...
        	throw new RuntimeException("Cannot create type by JDK serialization", e);
    ...
    protected void validateFieldAccess(Field field) {
        if (Modifier.isFinal(field.getModifiers())) {
            if (JVM.isVersion(5)) {
                ...
                throw new RuntimeException("Invalid final field "
