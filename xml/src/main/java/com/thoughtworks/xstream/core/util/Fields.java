...
public class Fields {
    ...
    private static RuntimeException wrap(final String message, final Class type, final String name,
            final Throwable ex) {
        final RuntimeException exception = new RuntimeException(message, ex);
