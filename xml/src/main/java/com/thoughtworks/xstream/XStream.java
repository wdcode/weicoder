...
//            e.add("version", version != null ? version : "not available");
    ...
    /**
     * @deprecated As of 1.3, use {@link RuntimeException}
     *             instead
     */
    public static class InitializationException extends RuntimeException { 
		...
		/**
         * @deprecated As of 1.3, use
         *             {@link RuntimeException#InitializationException(String, Throwable)}
         *             instead
         */
        ...
        /**
         * @deprecated As of 1.3, use
         *             {@link RuntimeException#InitializationException(String)}
         *             instead
         */
    ...
    private class InternalBlackList implements Converter {
        ...
        public void marshal(final Object source, final HierarchicalStreamWriter writer,
            ...
            throw new RuntimeException("Security alert. Marshalling rejected.");
        }

        public Object unmarshal(final HierarchicalStreamReader reader, final UnmarshallingContext context) {
            throw new RuntimeException("Security alert. Unmarshalling rejected.");
        }
    }
}
